...
// import { Popover, PopoverContent, PopoverTrigger } from "../ui/popover";
// import { Edit2, MoreHorizontal, Building2, Calendar, Search, Eye, Trash2, Users, Mail } from "lucide-react";
// import { useSelector } from "react-redux";
// import { useNavigate } from "react-router-dom";
...
//               <p className="text-2xl font-bold text-purple-900">{filterCompany.length}</p>
//             </div>
//           </div>
//         </div>
//       </motion.div>
...
//                   </div>
//                 </TableHead>
//                 <TableHead className="font-semibold text-gray-900 py-4">Industry</TableHead>
//                 <TableHead className="font-semibold text-gray-900 py-4">
//                   <div className="flex items-center gap-2">
...
//                           {searchCompanyByText 
//                             ? `No companies found matching "${searchCompanyByText}"`
...
//                                 className="w-full flex items-center gap-3 px-3 py-2 text-sm text-red-600 rounded-lg transition-colors duration-200"
//                               >
