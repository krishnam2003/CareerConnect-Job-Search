...
import { Edit2, Eye, MoreHorizontal, Building2, Briefcase, Calendar } from "lucide-react";
    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
      <div className="overflow-x-auto">
        <Table className="min-w-full">
          <TableCaption className="bg-gray-50 py-4 text-gray-600 text-sm font-medium">
            Your recent Posted Jobs • {filterJobs?.length || 0} job{filterJobs?.length !== 1 ? 's' : ''} found
          </TableCaption>
          <TableHeader className="bg-gradient-to-r from-gray-50 to-gray-100/80">
            <TableRow className="border-b border-gray-200 hover:bg-transparent">
              <TableHead className="py-4 font-semibold text-gray-700 text-sm uppercase tracking-wider">
              ...
              <TableHead className="py-4 font-semibold text-gray-700 text-sm uppercase tracking-wider text-right">
                Actions
              </TableHead>
            </TableRow>
          </TableHeader>
            ...
            {filterJobs.length === 0 ? (
              <TableRow className="hover:bg-gray-50/50">
                <TableCell colSpan={4} className="px-6 py-12 text-center">
                  <div className="flex flex-col items-center justify-center text-gray-400">
                    ...
                    <p className="text-lg font-medium text-gray-500 mb-1">No Jobs Found</p>
                    <p className="text-sm text-gray-400">Get started by posting your first job opening</p>
                  </div>
                </TableCell>
              </TableRow>
            ) : (
              filterJobs?.map((job) => (
                ...
                >
                  ...
                  <TableCell className="px-6 py-4 whitespace-nowrap">
                    <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800 border border-blue-200/60">
                      {job.title}
                    </span>
                  </TableCell>
                  ...
                  <TableCell className="px-6 py-4 whitespace-nowrap text-right">
                    <Popover>
                      <PopoverTrigger>
                        <div className="inline-flex items-center justify-center w-9 h-9 rounded-lg border border-gray-200 bg-white hover:bg-gray-50 hover:border-gray-300 hover:shadow-sm transition-all duration-200 group-hover:bg-blue-50 group-hover:border-blue-200">
                          <MoreHorizontal className="w-4 h-4 text-gray-600 group-hover:text-blue-600" />
                        </div>
                      </PopoverTrigger>
                      <PopoverContent className="w-40 p-2 rounded-xl shadow-lg border border-gray-200 bg-white">
                        <div
                          onClick={() => navigate(`/admin/companies/${job._id}`)}
                          className="flex items-center gap-3 w-full px-3 py-2 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors duration-150 group"
                        >
                        ...
                        >
                          ...
                          <span className="text-sm font-medium text-gray-700">Application Details</span>
                        </div>
                      </PopoverContent>
                    </Popover>
                  </TableCell>
...
// import { Popover, PopoverContent, PopoverTrigger } from "../ui/popover";
// import { Edit2, Eye, MoreHorizontal, Building2, Briefcase, Calendar, FileText } from "lucide-react";
// import { useSelector } from "react-redux";
// import { useNavigate } from "react-router-dom";
...
//   // Function to truncate description for table display
...
//                         <hr className="my-1 border-gray-200" />
//                         <div
//                           onClick={() => navigate(`/admin/jobs/${job._id}/description`)}
//                           className="flex items-center gap-3 w-full px-3 py-2 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors duration-150 group"
//                         >
...
//                       </div>
//                        <hr /> 
//                       <div onClick={() => navigate(`/description/${job._id}`)} className="flex items-center gap-2 w-fit cursor-pointer mt-1">
//                         <Eye className="w-4"></Eye>
